...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'blog5.com'
  config.app_name = 'Blog5'
  config.mailer.from = 'Blog5 <no-reply@blog5.com>'
  ...
  #
  config.app_secret = 'kyMDBdbGkR3W_l_TnfKtYGfoeVCLyi2W_KOsZXuWpB5VFTLPdPzviSvS2jGLtDoWMuQ'
